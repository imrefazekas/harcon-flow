...
module.exports = {
	...
	parse: function ( title, flowDef, validation = {}, timeout, callback ) {
		return new Promise( (resolve, reject) => {
			...
			try {
				...
				return Proback.resolver( { title: title, source: source, messages: messages, validation: validation, timeout: timeout }, callback, resolve)
